...
gcc -g Parsers/Ast.o stack/stack.o Parsers/lex.yy.o core/Catalog.o core/sql_intf.o core/sql_utils.o core/sql_io.o c-hashtable/hashtable.o c-hashtable/hashtable_itr.o BPlusTreeLib/BPlusTree.o core/select.o gluethread/glthread.o Tracer/tracer.o core/qplanner.o core/sql_where.o core/sql_groupby.o core/sql_delete.o -o exe -lfl -lm -lpthread
