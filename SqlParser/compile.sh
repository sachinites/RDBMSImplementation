...
g++ -g ../uapi/sql_api.o ../core/qep.o lex.yy.o SqlSelectParserCFG.o SqlCreateParserCFG.o ../BPlusTreeLib/BPlusTree.o ../BPlusTreeLib/BPlusTreeCompFn.o ../core/sql_utils.o ../core/sql_create.o ../core/Catalog.o ../gluethread/glthread.o SqlInsertIntoParserCFG.o ../core/sql_insert_into.o ../core/sql_delete.o ../c-hashtable/hashtable.o ../c-hashtable/hashtable_itr.o ../core/sql_io.o ../core/SqlMexprIntf.o ../core/sql_group_by.o ../core/sql_order_by.o SqlParserMain.o -o dbms.exe -lfl -lm -L ../../MathExpressionParser/ -lMexp

g++ -g ../BPlusTreeLib/BPlusTree.o ../BPlusTreeLib/BPlusTreeCompFn.o ../BPlusTreeLib/main.o -o ../BPlusTreeLib/BPlusTree.exe

g++ -g ../uapi/sql_api.o ../core/qep.o lex.yy.o SqlSelectParserCFG.o SqlCreateParserCFG.o ../BPlusTreeLib/BPlusTree.o ../BPlusTreeLib/BPlusTreeCompFn.o ../core/sql_utils.o ../core/sql_create.o ../core/Catalog.o ../gluethread/glthread.o SqlInsertIntoParserCFG.o ../core/sql_insert_into.o ../c-hashtable/hashtable.o ../c-hashtable/hashtable_itr.o ../core/sql_io.o ../core/SqlMexprIntf.o  ../core/sql_group_by.o ../core/sql_order_by.o ../uapi/sql_uapi_test.o -o ../uapi/sql_uapi_test.exe -lfl -lm -L ../../MathExpressionParser/ -lMexp
