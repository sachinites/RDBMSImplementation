...
gcc -g ../core/qep.o ../core/sql_mexpr_intf.o lex.yy.o SqlSelectParserCFG.o SqlCreateParserCFG.o SqlParserMain.o ../BPlusTreeLib/BPlusTree.o ../../MathExpressionParser/ParserMexpr.o ../../MathExpressionParser/MExpr.o ../../MathExpressionParser/ExpressionParser.o ../core/sql_utils.o ../core/sql_create.o ../core/Catalog.o ../gluethread/glthread.o SqlInsertIntoParserCFG.o ../core/sql_insert_into.o -o exe -lfl -lm
